...
const TypingIndicator = ({ isTyping, isTypingIndicatorBackgroundColor, isTypingIndicatorDotsColor, }) => {
    ...
    return (<Animated.View style={[
      ...
      {isTyping ? (<TypingAnimation style={{ marginLeft: 6, marginTop: 7.2 }} dotRadius={4} dotMargin={5.5} dotColor={isTypingIndicatorDotsColor
                ? isTypingIndicatorDotsColor
                : 'rgba(0, 0, 0, 0.38)'}/>) : null}
    </Animated.View>);
};
