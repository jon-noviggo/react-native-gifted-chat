...
export default class Send extends Component {
    ...
    render() {
        ...
        if (alwaysShowSend || (text && text.trim().length > 0)) {
            return (<TouchableOpacity testID='send' accessible accessibilityLabel='send' style={[styles.container, containerStyle]} onPress={this.handleOnPress} accessibilityHint='button' disabled={disabled} {...sendButtonProps}>
          <View>
