...
export default class MessageContainer extends React.PureComponent {
    constructor() {
        ...
        this.renderTypingIndicator = () => {
            ...
            return (<TypingIndicator isTyping={this.props.isTyping || false} isTypingIndicatorBackgroundColor={this.props.isTypingIndicatorBackgroundColor} isTypingIndicatorDotsColor={this.props.isTypingIndicatorDotsColor}/>);
        };
        this.renderFooter = () => {
